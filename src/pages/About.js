...
const About = () => {
  ...
  <div className="article">
    <div className="avatar"> <img src={about} alt="Skin" /></div>
    <p className="paragraph-about"> Welcome to Avon, where beauty is more than skin deep. For over 135
